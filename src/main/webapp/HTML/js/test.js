...
$(document).ready(function() {
    ...
    $.ajax({
        type: "GET",
        url: "http://localhost:8080/Ragnar-0.0.1-SNAPSHOT/ragnar/base_data/getUniqueImsi",
    ...
    $.ajax({
        type: "GET",
        url: "http://localhost:8080/Ragnar-0.0.1-SNAPSHOT/ragnar/base_data/getUniqueModels",
        success: function (value) {
            var array = value.toString();
            var strArray = array.split(",");
            $.each(strArray, function (index, value)
